...
#变量命名
FileAnsaInp=cur_dir+ "\\"+"YeLun-Solid-5.ansa.zst.inp" #ANSA导出的inp文件
...
FilePython8=cur_dir+ "\\"+"1PostGetFreq.py"#提取Freq的固有频率
FilePython9=cur_dir+ "\\"+"1ClearFile.py"#清除不必要的文件

FileThermal="PumpThermal"#文件名，
FileStatic="PumpStaticFreq"#文件名，
...
FileOutStatic   =cur_dir+ "\\"+"AbaqusOutPumpStatic.txt"#Static输出misese应力应变的文件
FileOutFreq     =cur_dir+ "\\"+"AbaqusOutPumpFreq.txt"#Static输出固有频率的文件
