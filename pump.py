...
def CmdStart(str):
    ...
    try:
        ...
        print(time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()) + " 结束")
        txt.config(state=DISABLED)
        btnThermal3.config(state=NORMAL)
        btnMoreStatic3.config(state=NORMAL)

def StartAbaqusThermal():
    global txt
    txt = txtAbaqus1
    # txt.delete(1.0, END)
    btnThermal3.config(state=DISABLED)
    txt.config(state=NORMAL)
    txt.insert(END, time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()) + " 开始分析\n")
    file_handle = open('MakeThermalCae.bat', 'w')
    ...
    file_handle.close()
    try:
        t1 = threading.Thread(target=CmdStart, args=("MakeThermalCae.bat",))
        t1.setDaemon(True)
        t1.start()
    except:
        txt.insert(END, '开始失败\n')
...
def StartMoreStatic():
    ...
    global txt
    txt = txtAbaqusMore
    btnMoreStatic3.config(state=DISABLED)
    txt.config(state=NORMAL)
    txt.insert(END, time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()) + " 开始分析\n")
...
def OptFit(data):
    ...
    x1,y1=sns.kdeplot(data,bw_adjust=0.1,clip=[0,xmin],gridsize=300,cumulative=False).get_lines()[0].get_data()
...
if __name__ == '__main__':
    ...
    tab_main.add(AbaqusFrame, text='强度振动分析')  # 将第一页插入分页栏中
    ...
    tab_main.add(AbaqusFrame5, text='强度振动批量分析')  # 将第一页插入分页栏中
    ...
    lbThermal4 = Label(AbaqusFrame, text='网格文件：YeLun-Solid-5.ansa.zst.inp',anchor='w',justify='left')
    ...
    btnThermal3 = Button(AbaqusFrame, text='开始分析', command=StartAbaqusThermal)
    btnThermal3.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.05)
    ...
    # lbStatic4 = Label(AbaqusFrame2, text='网格文件：PumpThermalStatic.ansa.zst.inp',anchor='w',justify='left')
    # lbStatic4.place(relx=0.1, rely=0.26, width=320, relheight=0.05)
    # lbStatic5 = Label(AbaqusFrame2, text='odb文件：PumpThermal.odb',anchor='w',justify='left')
    ...
    # btnStatic2 = Button(AbaqusFrame2, text='开始分析', command=StartAbaqusStatic)
    # btnStatic2.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.05)
    ...
    # lbFreqThermal4 = Label(AbaqusFrame3, text='单级网格文件：Pump-Freq-SingleBlade.inp',anchor='w',justify='left')
    # lbFreqThermal4.place(relx=0.1, rely=0.26, width=320, relheight=0.05)
    # lbFreqThermal5 = Label(AbaqusFrame3, text='整体网格文件：Pump-Freq-Whole.inp',anchor='w',justify='left')
    ...
    # btn2 = Button(AbaqusFrame3, text='开始分析', command=StartFreqThermal)
    # btn2.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.05)
    ...
    # lbFreqStatic4 = Label(AbaqusFrame4, text='网格文件：Pump-Freq-Whole.inp',anchor='w',justify='left')
    # lbFreqStatic4.place(relx=0.1, rely=0.26, width=320, relheight=0.05)
    # lbFreqStatic5 = Label(AbaqusFrame4, text='odb文件：PumpThermal.odb',anchor='w',justify='left')
    ...
    # # btn23 = Button(AbaqusFrame2, text='选择脚本文件根目录', command=ChScriptRootPath)
    # # btn23.place(relx=0.1, rely=0.20, relwidth=0.2, relheight=0.05)
    # btnFreqStatic2 = Button(AbaqusFrame4, text='开始分析', command=StartFreqStatic)
    # btnFreqStatic2.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.05)
    ...
    # 拉丁超立方抽样窗口
    lbLHS1 = Label(Frame0, text='抽样样本文件：未选择')
    ...
    lbMoreStatic4 = Label(AbaqusFrame5, text='CAE文件：PumpStaticFreq.cae',anchor='w',justify='left')
    lbMoreStatic4.place(relx=0.1, rely=0.26, width=320, relheight=0.05)
    lbMoreStatic5 = Label(AbaqusFrame5, text='ODB文件：PumpStaticFreq.odb',anchor='w',justify='left')
    ...
    btnMoreStatic3.place(relx=0.1, rely=0.40, relwidth=0.8, relheight=0.05)
    ...
    # lbFreqMoreStatic4 = Label(AbaqusFrame6, text='CAE文件：PumpStaticFreq.cae',anchor='w',justify='left')
    # lbFreqMoreStatic4.place(relx=0.1, rely=0.26, width=320, relheight=0.05)
    # lbFreqMoreStatic5 = Label(AbaqusFrame6, text='ODB文件：PumpThermal.odb',anchor='w',justify='left')
    ...
    # # btn23 = Button(AbaqusFrame2, text='选择脚本文件根目录', command=ChScriptRootPath)
    # # btn23.place(relx=0.1, rely=0.20, relwidth=0.2, relheight=0.05)
    # btnFreqMoreStatic2 = Button(AbaqusFrame6, text='开始分析', command=StartMoreFreq)
    # btnFreqMoreStatic2.place(relx=0.1, rely=0.4, relwidth=0.8, relheight=0.05)
    ...
    lbFreqEn = Label(Frame2, text='请输入前三节径在文件中所在的列数：')
    lbFreqEn.place(relx=0.04, rely=0.20, relwidth=0.28, relheight=0.05)
    addr = StringVar(value='3,5,7')
    ...
    lbFat2.place(relx=0.2, rely=0.12, relwidth=0.8, relheight=0.1)
    lbFat3 = Label(Frame3, text='选择概率分布文件：未选择')
    lbFat3.place(relx=0.2, rely=0.22, relwidth=0.8, relheight=0.1)
    lbFat4 = Label(Frame3, text='材料系数文件：未选择')
    lbFat4.place(relx=0.2, rely=0.32, relwidth=0.8, relheight=0.1)
    lbFat5 = Label(Frame3, text='文件保存路径：未选择')
    lbFat5.place(relx=0.2, rely=0.42, relwidth=0.8, relheight=0.1)
    ...
    btn3.place(relx=0.1, rely=0.24, relwidth=0.3, relheight=0.05)
    btn5 = Button(Frame3, text='选择材料疲劳数据文件（由《中国航空材料手册》查得）', command=chFileMater)
    btn5.place(relx=0.1, rely=0.34, relwidth=0.3, relheight=0.05)
    btn5 = Button(Frame3, text='选择文件保存路径', command=chFatRoot)
    btn5.place(relx=0.1, rely=0.44, relwidth=0.3, relheight=0.05)
    btn23 = Button(Frame3, text='开始分析', command=StartFatigue,)
    btn23.place(relx=0.1, rely=0.54, relwidth=0.8, relheight=0.05)
    lbFat6 = Label(Frame3, text='')
    lbFat6.place(relx=0.1, rely=0.59, relwidth=0.8, relheight=0.1)

    txt3 = Text(Frame3)
    txt3.config(state=DISABLED)
    txt3.place(rely=0.69, relheight=0.31, relwidth=1.0)
